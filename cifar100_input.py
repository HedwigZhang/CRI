...
data_dir = '/home/zhangxingpeng/cri/tf/sgrise'
full_data_dir = '/raid/data/zhangxingpeng/cifar-100-python/train'
vali_dir = '/raid/data/zhangxingpeng/cifar-100-python/test'
...
def read_in_all_images(address, shuffle=True, is_random_label = False):
    """
    ...
    :param address: paths of pickle files
    ...
    data, label = _read_one_batch(address, is_random_label)
...
def prepare_train_data(padding_size):
    ...
    data, label = read_in_all_images(full_data_dir, is_random_label=TRAIN_RANDOM_LABEL)
